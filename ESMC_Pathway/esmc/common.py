# -*- coding: utf-8 -*-
"""
Global variables (region codes, plotting colors and names, etc.).
...
# Repository root and log file name (one log file per run, saved in logs/)
PROJECT_DIR = Path(__file__).resolve().parents[1]
commons['logfile'] = datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_esmc.log'
...
# TODO how to differentiate imports from exterior fossil gas or h2 from exchanges with other cells?
