...
Usage (from the repository root):
    python -m esmc.preprocessing.generate_year_dat_files
...
# Repository root in the path (needed when run as a standalone script)
...
from esmc.common import CSV_SEPARATOR, bo_country_code, named_space_id, PROJECT_DIR
...
class YearDataGenerator:
    ...
    def print_indep_dat(self):
        ...
        dp.print_header(
            dat_file=indep_file,
            header_txt=f'File containing data independent of the modeled regions (Year {self.year})'
        )
