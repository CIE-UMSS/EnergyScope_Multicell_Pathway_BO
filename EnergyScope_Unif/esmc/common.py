...
bo_country_code = ['SIN', 'SA-BN', 'SA-PA', 'SA-TJ', 'SA-SC']
bo_full_names = ['Sistema Interconectado Nacional', 'Sistemas Aislados Beni', 'Sistemas Aislados Pando', 'Sistemas Aislados Tarija', 'Sistemas Aislados Santa Cruz']
